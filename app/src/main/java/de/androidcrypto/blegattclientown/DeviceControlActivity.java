...
public class DeviceControlActivity extends Activity {
    ...
    private final BroadcastReceiver mGattUpdateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothLeService.ACTION_GATT_CONNECTED.equals(action)) {
                mConnected = true;
                updateConnectionState(R.string.connected); // "Connected"
                invalidateOptionsMenu();
            } else if (BluetoothLeService.ACTION_GATT_DISCONNECTED.equals(action)) {
                mConnected = false;
                updateConnectionState(R.string.disconnected); // "Disconnected"
                invalidateOptionsMenu();
                clearUI();
    ...
    private void displayGattServices(List<BluetoothGattService> gattServices) {
        ...
        String uuid = null;
        String unknownServiceString = getResources().getString(R.string.unknown_service); // "Unknown service"
        String unknownCharaString = getResources().getString(R.string.unknown_characteristic); // "Unknown characteristic"
